...
function Para() {
  return (
    <div className="bigbasket-container">
             <Navbar.Brand href="#" className='logo'><h1>GROCERY</h1></Navbar.Brand>
      ...
      <h2>Slotted Delivery</h2>
      <p data-aos="fade-up">
        Choose the most convenient delivery slot to receive your groceries, ranging from early morning delivery for early birds to late-night delivery for those on the night shift. bigbasket caters to every schedule.
      </p>
